...
public class BaseFragment extends Fragment{
    ...
    public void setTitle(String title){
		...
		//set font
		HelvFont.HELV_LIGHT.apply(getActivity(), ((TextView)actionTitle.findViewById(R.id.titleActionBar)));
    ...
    public void setTitleSubtitle(String title, String subtitle){
		...
		//set font
		HelvFont.HELV_LIGHT.apply(getActivity(), ((TextView)actionTitle.findViewById(R.id.titleActionBar)));
		HelvFont.HELV_LIGHT.apply(getActivity(), ((TextView)actionTitle.findViewById(R.id.subtitleActionBar)));
		((TextView)actionTitle.findViewById(R.id.titleActionBar)).setText(title);
